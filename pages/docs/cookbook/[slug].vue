<template>
  <div
    ...
    <div class="w-full max-w-6xl flex flex-col mx-auto items-center gap-4">
      <NuxtLink
      to="/docs/cookbook" class="w-full flex justify-start items-center mb-4 no-underline gap-1 text-neutral-500 hover:text-neutral-700">
      ...
      <div class="relative prose prose-neutral w-full max-w-3xl mb-36 h-max">
        <ContentRenderer id="recipe-container" :value="recipe" class="recipe-content" />
      </div>
    </div>
  </div>
</template>  
